...
import { ComboColumn } from './columns'
...
function CellAction({ data }: ICellAction) {
  ...
  const handleCopy = (id: string) => {
    ...
    toast.success('ID del combo copiado')
  }
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align='end'>
          ...
          <DropdownMenuItem className='cursor-pointer' onClick={() => router.push(`/${params.storeId}/combos/${data.id}`)}>
